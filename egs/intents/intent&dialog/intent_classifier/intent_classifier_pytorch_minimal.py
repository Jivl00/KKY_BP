...
def evaluate_model(model_path, x_test, y_test, print_detail):
    ...
    if print_detail:  # Print predicted vs test classes
        # Load target names
        with open('intent_classifier/temp/target_names.pickle', 'rb') as rb:
...
def load_best_model(model_path="intent_classifier/models/best"):
    with open('intent_classifier/temp/neurons_num.pickle', 'rb') as rb:  # Load data (deserialize)
