...
def main():
    ...
    for hidden_layers in tested_params:
        for classes in classes_cut:
            print('Testing hidden layers: {} - classes: {}'.format(hidden_layers, classes))
            ...
            with open('analysis.txt', 'a', encoding='utf-8') as f:
                f.write("{}\t{}\t{}\t{}\n".format(len(target_names), hidden_layers, eval_accu, eval_loss))
