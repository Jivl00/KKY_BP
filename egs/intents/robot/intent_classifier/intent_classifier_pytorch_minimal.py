...
def evaluate_model(model_path, x_test, y_test, print_detail):
    ...
    if print_detail:  # Print predicted vs test classes
        # Load target names
        with open('/home/jivl/catkin_ws/src/beginner_tutorials/scripts/intent_classifier/temp/target_names.pickle', 'rb') as rb:
...
def load_best_model(model_path="/home/jivl/catkin_ws/src/beginner_tutorials/scripts/intent_classifier/models/best"):
    with open('/home/jivl/catkin_ws/src/beginner_tutorials/scripts/intent_classifier/temp/neurons_num.pickle', 'rb') as rb:  # Load data (deserialize)
...
if __name__ == '__main__':
    ...
    with open('intent_classifier/temp/neurons_num.pickle', 'wb') as wb:  # Store data (serialize) for model loading
    ...
    if NET_PARAMS['overwrite_best_model']:
        best_model_path = "intent_classifier/models/best"
    else:
